...
function createStyles(colors) {
  return StyleSheet.create({
    ...
    container: { padding: 16, paddingBottom: 92, gap: 14 },
    ...
    bottomNav: { position: 'absolute', left: 8, right: 8, bottom: 8, minHeight: 58, borderRadius: 18, backgroundColor: colors.nav, borderWidth: 1, borderColor: colors.line, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', paddingHorizontal: 5 },
    navItem: { flex: 1, minHeight: 48, borderRadius: 14, alignItems: 'center', justifyContent: 'center', gap: 2 },
