...
export const api = {
  ...
  ghislainSummary: () => apiRequest('/ghislain/summary'),
  ghislainCashbookEntries: () => apiRequest('/ghislain/cashbook'),
  createGhislainCashbookEntry: (body) => apiRequest('/ghislain/cashbook', { method: 'POST', body: JSON.stringify(body) }),
  updateGhislainCashbookEntry: (id, body) => apiRequest(`/ghislain/cashbook/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  deleteGhislainCashbookEntry: (id) => apiRequest(`/ghislain/cashbook/${id}`, { method: 'DELETE' }),
  ghislainBudgetEntries: () => apiRequest('/ghislain/budget'),
  createGhislainBudgetEntry: (body) => apiRequest('/ghislain/budget', { method: 'POST', body: JSON.stringify(body) }),
  updateGhislainBudgetEntry: (id, body) => apiRequest(`/ghislain/budget/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  deleteGhislainBudgetEntry: (id) => apiRequest(`/ghislain/budget/${id}`, { method: 'DELETE' }),
  ...
  webPushPublicKey: () => apiRequest('/notifications/web-push/public-key'),
  webPushStatus: () => apiRequest('/notifications/web-push/status'),
  subscribeWebPush: (body) => apiRequest('/notifications/web-push/subscribe', { method: 'POST', body: JSON.stringify(body) }),
  unsubscribeWebPush: (body) => apiRequest('/notifications/web-push/subscribe', { method: 'DELETE', body: JSON.stringify(body) }),
  testWebPush: () => apiRequest('/notifications/web-push/test', { method: 'POST' }),
  runDeadlinePushAlerts: () => apiRequest('/notifications/web-push/deadlines/run', { method: 'POST' }),
  ...
  updateInvoice: (id, body) => apiRequest(`/invoices/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  ...
  updatePayment: (id, body) => apiRequest(`/payments/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  deletePayment: (id) => apiRequest(`/payments/${id}`, { method: 'DELETE' }),
  kits: () => apiRequest('/equipment/kits'),
  createKit: (body) => apiRequest('/equipment/kits', { method: 'POST', body: JSON.stringify(body) }),
  equipmentAssignments: () => apiRequest('/equipment/assignments'),
  assignEquipment: (body) => apiRequest('/equipment/assignments', { method: 'POST', body: JSON.stringify(body) }),
  updateEquipmentAssignment: (id, body) => apiRequest(`/equipment/assignments/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  deleteEquipmentAssignment: (id) => apiRequest(`/equipment/assignments/${id}`, { method: 'DELETE' }),
